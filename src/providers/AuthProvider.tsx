/**
 * Auth context and provider: Firebase user, Firestore user profile, loading, refresh.
 * Used by root layout for route guards and by screens for current user/profile.
 */
...
/** Auth context value: user, userProfile, loading, refreshUserProfile. */
...
/** Hook to access current Firebase user, Firestore profile, loading, and refresh. */
...
/** Provides auth state and user profile to the app. */
